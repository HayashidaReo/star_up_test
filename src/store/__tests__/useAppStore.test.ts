...
describe('useAppStore', () => {
  ...
  describe('participants', () => {
    ...
    it('should remove related expenses when participant is removed', () => {
      const { addParticipant, addExpense, removeParticipant } = useAppStore.getState();
  ...
  describe('expenses', () => {
    ...
    it('should remove expense', () => {
      const { addParticipant, addExpense, removeExpense } = useAppStore.getState();
  ...
  describe('settlements', () => {
    ...
    it('should calculate settlements manually', () => {
      const { addParticipant, addExpense, calculateSettlements } = useAppStore.getState();
